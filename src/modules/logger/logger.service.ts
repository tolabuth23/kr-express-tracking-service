...
export class LoggerService extends ConsoleLogger {
  ...
  constructor(ctx = 'Logger') {
    ...
    if (isProduction) {
      const cloudwatchOptions: WinstonCloudwatch.CloudwatchTransportOptions = {
        name: this.ctx,
        uploadRate: 2000,
        ...
        cloudWatchLogs: new CloudWatchLogs({ region: 'ap-southeast-1' }),
        messageFormatter: cloudWatchFormatter,
      }
      this.winstonLogger.add(new WinstonCloudwatch(cloudwatchOptions))
    }
  }
